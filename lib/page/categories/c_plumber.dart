...
class C_plumber extends StatefulWidget {
  const C_plumber({super.key});

  @override
  State<C_plumber> createState() => _C_plumberState();
}

class _C_plumberState extends State<C_plumber> {
  @override
      ...
      child: Card(
        child: ListTile(
          ...
          subtitle: Column(
            ...
            children: [
              Text('Junior plumber'),
              Text('Batticalo, Sri Lanka'),
              Text('19/01/2023'),
              Text('Salary: 55,000/=  Phone no: 077 5454787'),
              Text('Company name: polo'),
              Text('Qualification: no need'),
