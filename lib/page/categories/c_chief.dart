...
class C_chief extends StatefulWidget {
  const C_chief({super.key});

  @override
  State<C_chief> createState() => _C_chiefState();
}

class _C_chiefState extends State<C_chief> {
  @override
        ...
        child: ListTile(
          ...
          subtitle: Column(
            ...
            children: [
              ...
              Text('19/01/2023'),
              Text('Salary: 155 000/=  Phone no: 077 5454787'),
              Text('Hotel name: Sea breash'),
              Text('Qualification: Need to have 2 year experience'),
