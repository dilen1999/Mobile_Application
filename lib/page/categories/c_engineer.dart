...
class C_engineer extends StatefulWidget {
  const C_engineer({super.key});

  @override
  State<C_engineer> createState() => _C_engineerState();
}

class _C_engineerState extends State<C_engineer> {
  @override
        ...
        child: ListTile(
          ...
          subtitle: Column(
            ...
            children: [
              ...
              Text('19/01/2023'),
              Text('Salary: 165,000/=  Phone no: 077 5454787'),
              Text('Company name: WSO2'),
              Text('Qualification: Need to have software degree'),
