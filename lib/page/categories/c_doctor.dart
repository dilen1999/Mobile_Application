...
class C_doctor extends StatefulWidget {
  const C_doctor({super.key});

  @override
  State<C_doctor> createState() => _C_doctorState();
}

class _C_doctorState extends State<C_doctor> {
  @override
        ...
        child: ListTile(
          ...
          subtitle: Column(
            ...
            children: [
              ...
              Text('Hospital name: Apollo Hospitals'),
              Text('Qualification: Need to have MBBS degree'),
