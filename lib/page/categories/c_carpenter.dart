...
class C_carpenter extends StatefulWidget {
  const C_carpenter({super.key});

  @override
  State<C_carpenter> createState() => _C_carpenterState();
}

class _C_carpenterState extends State<C_carpenter> {
  @override
      ...
      child: Card(
        child: ListTile(
          ...
          subtitle: Column(
            ...
            children: [
              Text('Fresher carpenter'),
              Text('Jaffna, Sri Lanka'),
              Text('19/01/2023'),
              Text('Salary: 75 000/=  Phone no: 077 5454787'),
              Text('Company name: Anto'),
              Text('Qualification: Need 1 year experience'),
